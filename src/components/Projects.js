...
const projectsData = [
    ...
    { id: 6, title: 'Mon vieux grimoire', images: [project2Image1, project2Image2, project2Image3], descriptionShort: "Plateforme de gestion de livres.", description: "Développement de l'API RESTful pour un site de notation de livres. Le projet inclut la mise en place d'un système d'authentification sécurisé pour les utilisateurs, la gestion des opérations CRUD complètes pour les livres et leurs notations, ainsi qu'un middleware pour l'optimisation à la volée des images. L'architecture de l'application est structurée selon le modèle MVC pour assurer la maintenabilité du code.", technologies: ['Node.js', 'Express', 'MongoDB'], liveDemo: 'https://mon-vieux-grimoire-frontend-auz1.onrender.com/', sourceCode: 'https://github.com/Alexkg79/Back-end-Book', learnings: [
